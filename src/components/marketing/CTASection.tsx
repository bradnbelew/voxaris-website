    ...
    <section data-section="cta" className="relative py-20 lg:py-28 bg-carbon-900 overflow-hidden">
      ...
      <div className="max-w-[900px] mx-auto px-6 sm:px-8 text-center relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <img src="/voxaris-logo-white.png" alt="Voxaris — AI-powered voice and video agents for business" className="h-16 w-auto opacity-40" />
        </motion.div>
        ...
        >
          ...
          <Link to="/book-demo">
            <button
              className="rounded-full text-white/60 hover:text-white h-14 px-8 text-[15px] font-medium border border-white/20 hover:border-white/35 transition-all duration-200 bg-transparent"
            >
              Book a Demo
            </button>
          </Link>
