...
const navLinks = [
  { label: 'Product', href: '/#features' },
  {
    ...
    href: '#',
    dropdown: [
      { label: 'Hotels & Resorts', href: '/solutions/dealerships', desc: 'AI concierge for direct bookings' },
      { label: 'Car Dealerships', href: '/solutions/dealerships', desc: 'AI sales agents for auto' },
      { label: 'Timeshares & Vacation Rentals', href: '/solutions/direct-mail', desc: 'Tour bookings & guest engagement' },
      { label: 'Luxury Real Estate', href: '/solutions/contractors', desc: 'AI buyer concierge' },
