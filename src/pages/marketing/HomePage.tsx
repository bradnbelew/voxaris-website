...
const solutionTiles = [
  {
    ...
    tagline: 'AI video-interviews every applicant.',
    body: 'An AI agent video-interviews every candidate the moment they apply. It scores fit, surfaces strengths and concerns, and hands you a ranked shortlist with recordings — so your team only sits down with people worth their time.',
    icon: Users,
    color: 'text-blue-400',
    bg: 'bg-blue-500/10',
  ...
  },
  {
    ...
    body: 'Fast, modern, mobile-first website built for your business. Conversion-optimized layout, local SEO foundation, live in 48 hours.',
    icon: Globe,
